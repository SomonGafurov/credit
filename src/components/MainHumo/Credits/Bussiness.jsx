...
const Bussiness = () => {
  ...
  return (
    <div>
      <img src="/bussinesss.jpg" alt="" className="agro" />

      <p className="animal-text">
        {" "}
        Старт <br /> бизнес
      </p>
      <div className="text-agro-b">
        <h2 className="text-cred-1"> Старт бизнес</h2>
        <p>
          Кредиты на развитие бизнеса помогают заёмщикам увеличить рабочий
          капитал или основные средства. Такой кредит может быть использован для
          следующей деятельности: торговля, производство, переработка продукции,
          транспорт и услуги.
        </p>
        <h5 className="text-cred">
          Гарантия: движимое и недвижимое имущество.
        </h5>
        <h5 className="text-cred">
          {" "}
          Сумма: от 500 до 10 000 сомони только для женщин.
        </h5>
        <h5 className="text-cred">
          Продолжительность займа: от 3 до 24 месяцев.
        </h5>
        <h5 className="text-cred">
